...
3. For External packages: Requires submodule + project creation + patches
...
### When Build Fails
1. Try building individual package: `./build.sh -sb --projects path/to/package.csproj`
...
4. Always add explanatory comments for manual fixes
