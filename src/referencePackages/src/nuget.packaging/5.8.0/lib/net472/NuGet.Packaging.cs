...
namespace NuGet.Packaging
{
    ...
    public static partial class FrameworkNameUtility
    {
        ...
        public static NuGet.Frameworks.NuGetFramework ParseNuGetFrameworkFolderName(string path, bool strictParsing, out string effectivePath) { throw null; }
        public static NuGet.Frameworks.NuGetFramework ParseNuGetFrameworkFromFilePath(string filePath, out string effectivePath) { throw null; }
    }
    public sealed partial class FrameworkReference : System.Collections.Generic.IComparer<NuGet.Packaging.FrameworkReference>, System.IComparable<NuGet.Packaging.FrameworkReference>, System.IEquatable<NuGet.Packaging.FrameworkReference>
    {
    ...
    public partial interface IPackageFile
    {
        ...
        NuGet.Frameworks.NuGetFramework NuGetFramework { get; }
        string Path { get; }
        [System.ObsoleteAttribute("Use NuGetFramework instead. This property will be null for any frameworks net5.0 or above.")]
    ...
    [System.ObsoleteAttribute("Use NuGet.Protocol.LocalPackageArchiveDownloader")]
    ...
    {
        public static System.Xml.Schema.XmlSchemaSet GetManifestSchemaSet(string schemaNamespace) { throw null; }
    ...
    public partial class PackageExtractionTelemetryEvent : NuGet.Common.TelemetryEvent
    {
        ...
        public PackageExtractionTelemetryEvent(NuGet.Packaging.PackageSaveMode packageSaveMode, NuGet.Common.NuGetOperationStatus status, NuGet.Packaging.ExtractionSource extractionSource, NuGet.Packaging.Core.PackageIdentity packageId = null) : base (default(string)) { }
        ...
        public void LogPackageIdentity(NuGet.Packaging.Core.PackageIdentity packageId) { }
        public void SetResult(NuGet.Common.NuGetOperationStatus status) { }
    }
    ...
    public partial class PackageSigningTelemetryEvent : NuGet.Common.TelemetryEvent
    {
        ...
        public PackageSigningTelemetryEvent() : base (default(string)) { }
        ...
        public NuGet.Common.NuGetOperationStatus Status { get { throw null; } }
        public void SetResult(NuGet.Packaging.PackageSignType packageSignType, NuGet.Common.NuGetOperationStatus status) { }
    }
    ...
    public partial class PhysicalPackageFile : NuGet.Packaging.IPackageFile
    {
        ...
        public NuGet.Frameworks.NuGetFramework NuGetFramework { get { throw null; } }
...
namespace NuGet.Packaging.Rules
{
    ...
    public partial class IconUrlDeprecationWarning : NuGet.Packaging.Rules.IPackageRule
    {
...
namespace NuGet.Packaging.Signing
{
    ...
    {
        public static System.Security.Cryptography.CryptographicAttributeObject CreateCommitmentTypeIndication(NuGet.Packaging.Signing.SignatureType type) { throw null; }
        ...
        public static System.Security.Cryptography.CryptographicAttributeObject CreateSigningCertificateV2(System.Security.Cryptography.X509Certificates.X509Certificate2 certificate, NuGet.Common.HashAlgorithmName hashAlgorithm) { throw null; }
        ...
        public static NuGet.Packaging.Signing.SignatureType GetSignatureType(System.Security.Cryptography.CryptographicAttributeObjectCollection signedAttributes) { throw null; }
        public static NuGet.Packaging.Signing.SignatureType GetSignatureType(string oid) { throw null; }
        public static string GetSignatureTypeOid(NuGet.Packaging.Signing.SignatureType signatureType) { throw null; }
    }
    public sealed partial class AuthorPrimarySignature : NuGet.Packaging.Signing.PrimarySignature
    {
        public AuthorPrimarySignature(System.Security.Cryptography.Pkcs.SignedCms signedCms) : base (default(System.Security.Cryptography.Pkcs.SignedCms), default(NuGet.Packaging.Signing.SignatureType)) { }
        public override string FriendlyName { get { throw null; } }
        public override NuGet.Packaging.Signing.SignatureVerificationSummary Verify(NuGet.Packaging.Signing.Timestamp timestamp, NuGet.Packaging.Signing.SignatureVerifySettings settings, NuGet.Common.HashAlgorithmName fingerprintAlgorithm, System.Security.Cryptography.X509Certificates.X509Certificate2Collection certificateExtraStore) { throw null; }
    }
    ...
    public partial interface ISignature
    {
        ...
        NuGet.Packaging.Signing.SignatureType Type { get; }
    }
    ...
    {
        protected PrimarySignature(System.Security.Cryptography.Pkcs.SignedCms signedCms, NuGet.Packaging.Signing.SignatureType signatureType) : base (default(System.Security.Cryptography.Pkcs.SignerInfo), default(NuGet.Packaging.Signing.SignatureType)) { }
        public override string FriendlyName { get { throw null; } }
        public NuGet.Packaging.Signing.SignatureContent SignatureContent { get { throw null; } }
        ...
        public static NuGet.Packaging.Signing.PrimarySignature Load(byte[] data) { throw null; }
        public static NuGet.Packaging.Signing.PrimarySignature Load(System.IO.Stream stream) { throw null; }
        public static NuGet.Packaging.Signing.PrimarySignature Load(System.Security.Cryptography.Pkcs.SignedCms cms) { throw null; }
        public void Save(System.IO.Stream stream) { }
    ...
    {
        public static NuGet.Packaging.Signing.PrimarySignature CreateSignature(System.Security.Cryptography.Pkcs.SignedCms signedCms) { throw null; }
    }
    ...
    {
        internal RepositoryCountersignature() : base (default(System.Security.Cryptography.Pkcs.SignerInfo), default(NuGet.Packaging.Signing.SignatureType)) { }
        public override string FriendlyName { get { throw null; } }
        public System.Collections.Generic.IReadOnlyList<string> PackageOwners { get { throw null; } }
        public System.Uri V3ServiceIndexUrl { get { throw null; } }
    ...
    {
        public RepositoryPrimarySignature(System.Security.Cryptography.Pkcs.SignedCms signedCms) : base (default(System.Security.Cryptography.Pkcs.SignedCms), default(NuGet.Packaging.Signing.SignatureType)) { }
        public override string FriendlyName { get { throw null; } }
        public System.Collections.Generic.IReadOnlyList<string> PackageOwners { get { throw null; } }
        public System.Uri V3ServiceIndexUrl { get { throw null; } }
        public override NuGet.Packaging.Signing.SignatureVerificationSummary Verify(NuGet.Packaging.Signing.Timestamp timestamp, NuGet.Packaging.Signing.SignatureVerifySettings settings, NuGet.Common.HashAlgorithmName fingerprintAlgorithm, System.Security.Cryptography.X509Certificates.X509Certificate2Collection certificateExtraStore) { throw null; }
    ...
    public partial class Rfc3161TimestampProvider : NuGet.Packaging.Signing.ITimestampProvider
    {
        ...
        public System.Threading.Tasks.Task<NuGet.Packaging.Signing.PrimarySignature> TimestampSignatureAsync(NuGet.Packaging.Signing.PrimarySignature primarySignature, NuGet.Packaging.Signing.TimestampRequest request, NuGet.Common.ILogger logger, System.Threading.CancellationToken token) { throw null; }
    }
    public sealed partial class Rfc3161TimestampTokenInfo : System.Security.Cryptography.AsnEncodedData
    {
        ...
        public byte[] GetMessageHash() { throw null; }
        public byte[] GetNonce() { throw null; }
        public byte[] GetSerialNumber() { throw null; }
        public byte[] GetTimestampAuthorityName() { throw null; }
        public bool HasMessageHash(byte[] hash) { throw null; }
    }
    public abstract partial class Signature : NuGet.Packaging.Signing.ISignature
    {
        protected Signature(System.Security.Cryptography.Pkcs.SignerInfo signerInfo, NuGet.Packaging.Signing.SignatureType type) { }
        ...
        public System.Collections.Generic.IReadOnlyList<NuGet.Packaging.Signing.Timestamp> Timestamps { get { throw null; } }
        public NuGet.Packaging.Signing.SignatureType Type { get { throw null; } }
        public abstract byte[] GetSignatureValue();
        public string GetSigningCertificateFingerprint(NuGet.Common.HashAlgorithmName algorithm) { throw null; }
        protected abstract void ThrowForInvalidSignature();
        public virtual NuGet.Packaging.Signing.SignatureVerificationSummary Verify(NuGet.Packaging.Signing.Timestamp timestamp, NuGet.Packaging.Signing.SignatureVerifySettings settings, NuGet.Common.HashAlgorithmName fingerprintAlgorithm, System.Security.Cryptography.X509Certificates.X509Certificate2Collection certificateExtraStore) { throw null; }
    }
    ...
    {
        public static NuGet.Packaging.Signing.IX509CertificateChain GetCertificateChain(NuGet.Packaging.Signing.PrimarySignature primarySignature) { throw null; }
        public static NuGet.Packaging.Signing.IX509CertificateChain GetCertificateChain(NuGet.Packaging.Signing.PrimarySignature primarySignature, NuGet.Packaging.Signing.RepositoryCountersignature repositoryCountersignature) { throw null; }
        public static NuGet.Packaging.Signing.IX509CertificateChain GetTimestampCertificateChain(NuGet.Packaging.Signing.PrimarySignature primarySignature) { throw null; }
        public static NuGet.Packaging.Signing.IX509CertificateChain GetTimestampCertificateChain(NuGet.Packaging.Signing.PrimarySignature primarySignature, NuGet.Packaging.Signing.RepositoryCountersignature repositoryCountersignature) { throw null; }
        public static bool HasRepositoryCountersignature(NuGet.Packaging.Signing.PrimarySignature primarySignature) { throw null; }
    }
    ...
    public sealed partial class SignedPackageVerifierSettings
    {
        ...
        public static NuGet.Packaging.Signing.SignedPackageVerifierSettings GetAcceptModeDefaultPolicy(NuGet.Common.IEnvironmentVariableReader environmentVariableReader = null) { throw null; }
        public static NuGet.Packaging.Signing.SignedPackageVerifierSettings GetDefault(NuGet.Common.IEnvironmentVariableReader environmentVariableReader = null) { throw null; }
        public static NuGet.Packaging.Signing.SignedPackageVerifierSettings GetRequireModeDefaultPolicy(NuGet.Common.IEnvironmentVariableReader environmentVariableReader = null) { throw null; }
        public static NuGet.Packaging.Signing.SignedPackageVerifierSettings GetVerifyCommandDefaultPolicy(NuGet.Common.IEnvironmentVariableReader environmentVariableReader = null) { throw null; }
    }
    ...
    {
        public static System.Security.Cryptography.Pkcs.CmsSigner CreateCmsSigner(NuGet.Packaging.Signing.SignPackageRequest request, NuGet.Common.ILogger logger) { throw null; }
        public static System.Security.Cryptography.CryptographicAttributeObjectCollection CreateSignedAttributes(NuGet.Packaging.Signing.RepositorySignPackageRequest request, System.Collections.Generic.IReadOnlyList<System.Security.Cryptography.X509Certificates.X509Certificate2> chainList) { throw null; }
        public static System.Security.Cryptography.CryptographicAttributeObjectCollection CreateSignedAttributes(NuGet.Packaging.Signing.SignPackageRequest request, System.Collections.Generic.IReadOnlyList<System.Security.Cryptography.X509Certificates.X509Certificate2> chainList) { throw null; }
    ...
    {
        public UnknownPrimarySignature(System.Security.Cryptography.Pkcs.SignedCms signedCms) : base (default(System.Security.Cryptography.Pkcs.SignedCms), default(NuGet.Packaging.Signing.SignatureType)) { }
    }
...
namespace NuGet.RuntimeModel
{
    ...
    public sealed partial class JsonObjectWriter : NuGet.RuntimeModel.IObjectWriter, System.IDisposable
    {
