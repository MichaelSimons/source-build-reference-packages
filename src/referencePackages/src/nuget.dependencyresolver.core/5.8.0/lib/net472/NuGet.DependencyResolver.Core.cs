...
namespace NuGet.DependencyResolver
{
    ...
    public sealed partial class GraphItemKeyComparer<T> : System.Collections.Generic.IEqualityComparer<NuGet.DependencyResolver.GraphItem<T>>
    {
        internal GraphItemKeyComparer() { }
        public static NuGet.DependencyResolver.GraphItemKeyComparer<T> Instance { get { throw null; } }
        public bool Equals(NuGet.DependencyResolver.GraphItem<T> x, NuGet.DependencyResolver.GraphItem<T> y) { throw null; }
        public int GetHashCode(NuGet.DependencyResolver.GraphItem<T> obj) { throw null; }
    }
